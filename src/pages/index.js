...
import codezone from "../images/codezone.png";
...
const IndexPage = () => {
  return (
    <main>
        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          <div class="font-montserrat flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <a href="https://flowbite.com" class="flex items-center">
              <img src={codezone} class="mr-3 h-6 sm:h-9" alt="Codezone Logo" />
      ...
      <section class="font-roboto bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              ...
              contest globally. Ready to embark on your coding journey? Join the
              Code Zone family today and let's turn your coding dreams into
              reality. Your coding adventure starts here!
            </p>
      ...
      <section class="bg-white dark:bg-gray-900" id="about-us">
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            ...
            <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">
              In-depth courses designed to get you job ready and hired by top
              companies.
            </p>
          </div>
          <div className="max-w-md mx-auto bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="px-6 py-6">
              <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <p>Complete Interview Preparation</p>
              </h5>
              <p className="font-normal pt-1 text-gray-700 dark:text-gray-400">
                <p>
                  This course will help you ace any interview, whether it's for
                ...
                <div className="max-w-lg mx-auto pt-10">
                  <ul className="list-disc">
                    ...
                    >
                      Coding Languages: Master the art of coding with our
                      in-depth courses in various programming languages.
                    </ListItem>
                    <ListItem
                      icon={<FaCube className="w-6 h-6 text-green-500" />}
                    >
                      Data Structures and Algorithms: Build a strong foundation
      ...
      <section class="bg-white dark:bg-gray-900">
        ...
        <section class="bg-[#000b76] dark:bg-gray-900">
          <div class="py-8 lg:py-16 !pt-0 mx-auto max-w-screen-xl px-4">
            <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-left text-white dark:text-white md:text-4xl">
              Grow with Code Zone
            </h2>
            <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
              <a href="#" class="flex justify-center items-center">
                <svg
                  class="h-9 hover:text-white"
                  viewBox="0 0 125 35"
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
                >
